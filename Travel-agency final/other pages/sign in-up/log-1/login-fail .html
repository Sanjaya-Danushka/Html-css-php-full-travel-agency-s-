...
<head>
    ...
    <title>Travel Bee sign up</title>
...
<body>
<div class="form">
    <form action="fail.php" class="sign-in" method="post">
...
<div class="text">
    <h3>Are you new ?</h3>
    <P>Welcome travel Bee family. If you already member click sign up now</P>
    <a href="../sign in/sign-in.html">Sign Up</a>
</div>
<img src="include/t1.png" class="image" alt="">
</div>
<div class="last">
    <h2>Invalid username or password ! try again</h2>
    <img src="include/crying.png">
</div>
</body>
</html>